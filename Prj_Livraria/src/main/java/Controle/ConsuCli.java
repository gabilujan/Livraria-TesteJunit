...
public class ConsuCli extends JFrame {
    ...
    public ConsuCli(){
        ...
        Con = new JLabel("Consultar Clientes ");  
        Con.setBounds(410, -60, 220, 200);
        Con.setFont(new Font("Arial",Font.BOLD,20));
        Con.setForeground(Color.white);
        
        fil = new JLabel("Pesquisar por nome: ");
        fil.setBounds(230, -20, 220, 200);
...
// ... Seu código posterior ...
        ...
        setTitle("Consulta de Dados Cliente");
        setResizable(false);
        setSize(1000, 750);
        setVisible(true);
